...
class PrivateFunctionalTemplates
{
	 ...
	 * */
	public static String HierarchicalStateMachineClassConstructorSharedBody(String className_,String parentClassName_,Map<Util.Pair<String,String>,Util.Pair<String,String>> machine_,Map<String,String> subMachines_,String intialState_,Boolean rt_)
	{
		String source="";
	...
	public static String SimpleStateMachineClassConstructorSharedBody(String className_,Map<Util.Pair<String,String>,Util.Pair<String,String>> machine_,String intialState_,Boolean rt_)
	{
		String source="";
		if(rt_)
		{
	...
	public static String StateMachineClassConstructorSharedBody(String className_,Map<Util.Pair<String,String>,Util.Pair<String,String>> machine_,String intialState_)
	{
		return StateMachineClassConstructorSharedBody(className_, null, machine_, intialState_);
	}

	public static String StateMachineClassConstructorSharedBody(String className_,String parentClassName_,Map<Util.Pair<String,String>,Util.Pair<String,String>> machine_,String intialState_)
	{
		String source="";
		for (Map.Entry<Util.Pair<String,String>, Util.Pair<String,String>> entry : machine_.entrySet())
		{
	...
	public static String ParamList(List<Util.Pair<String, String>> params_)
	{
