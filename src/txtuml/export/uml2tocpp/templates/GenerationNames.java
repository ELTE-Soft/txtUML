...
class GenerationNames
{
	...
	public static final String EventFParamName= FormatIncomignParamName(EventParamName);
	...
	public static final String CompositeStateMap="std::unordered_map<int,"+CompositeStateMapSmType+" > "+CompositeStateMapName+";\n";
	...
	public static final String ActionCallerDecl="bool "+ActionCallerFName+"("+EventBaseRefName+" "+EventFParamName+");\n";
	...
	public static String HierachicalProcessEventDef(String className_)
	{
		return "bool "+className_+"::"+ProcessEventFName+"("+EventBaseRefName+" "+EventFParamName+")\n"+
				"{\n"+
					...
					"{\n"+
						"if("+CurrentMachineName+"->"+ProcessEventFName+"("+EventFParamName+"))\n"+
						"{\n"+
							"handled=true;\n"+
						"}\n"+
					"}\n"+
					"if(!handled)\n"+
					"{\n"+
						"handled=handled || "+ActionCallerFName+"("+EventFParamName+");\n"+
	...
	private static final String SimpleProcessEventDefBody()
	{
		return "{\n"+
				"bool handled=false;\n"+
				"auto range = "+TransitionTableName+".equal_range(EventState("+EventFParamName+".t,"+CurrentStateName+"));\n"+
				"if(range.first!="+TransitionTableName+".end())\n"+
				"{\n"+
	...
	public static String FormatIncomignParamName(String paramName_)
	{
