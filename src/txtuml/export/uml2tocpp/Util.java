...
public class Util {
	...
	public static class Pair<L,R> {
	  ...
	  public static Model loadModel(String modelUri) 
	  {
		...
		URI _uri = URI.createURI("jar:file:F:/!!!!!Egyetem/!!!!!!!!!!!!!!!!!!!!!Msc/!!!Xtumlprojekt/!!eclipseemf/eclipse/plugins/org.eclipse.uml2.uml.resources_4.1.0.v20140202-2055.jar!/"); // for example
		uriMap.put(URI.createURI(UMLResource.LIBRARIES_PATHMAP), _uri.appendSegment("libraries").appendSegment(""));
		uriMap.put(URI.createURI(UMLResource.METAMODELS_PATHMAP), _uri.appendSegment("metamodels").appendSegment(""));
		uriMap.put(URI.createURI(UMLResource.PROFILES_PATHMAP), _uri.appendSegment("profiles").appendSegment(""));
