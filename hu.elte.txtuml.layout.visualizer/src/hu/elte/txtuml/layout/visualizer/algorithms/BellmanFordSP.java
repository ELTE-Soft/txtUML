 ...
 * of edges. Afterwards, the <tt>distTo()</tt>, <tt>hasPathTo()</tt>, and
 * <tt>hasNegativeCycle()</tt> methods take constant time; the <tt>pathTo()</tt>
 * and <tt>negativeCycle()</tt> method takes time proportional to the number of
 * edges returned.
 * <p>
