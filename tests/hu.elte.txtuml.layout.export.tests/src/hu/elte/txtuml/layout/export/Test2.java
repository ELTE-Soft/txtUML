...
import hu.elte.txtuml.layout.export.model2.associations.ColumnBottom_ColumnBottom;
import hu.elte.txtuml.layout.export.model2.associations.ColumnMiddle_ColumnBottom;
import hu.elte.txtuml.layout.export.model2.associations.ColumnTop_ColumnMiddle;
import hu.elte.txtuml.layout.export.model2.associations.DiamondBottom_DiamondLeft;
import hu.elte.txtuml.layout.export.model2.associations.DiamondBottom_DiamondRight;
import hu.elte.txtuml.layout.export.model2.associations.DiamondLeft_DiamondRight;
import hu.elte.txtuml.layout.export.model2.associations.DiamondTop_DiamondBottom;
import hu.elte.txtuml.layout.export.model2.associations.DiamondTop_DiamondLeft;
import hu.elte.txtuml.layout.export.model2.associations.DiamondTop_DiamondRight;
import hu.elte.txtuml.layout.export.model2.associations.Random_BaseOfColumnTop;
import hu.elte.txtuml.layout.export.model2.associations.Random_BaseOfDiamond;
...
class Diagram2 extends Diagram {
	...
	@West(val = ColumnGroup.class, from = { DiamondTop.class, DiamondLeft.class, DiamondRight.class,
			DiamondBottom.class })
...
public class Test2 extends BaseTest {
	...
	public void run() {
		...
		undirectedLink(ColumnTop_ColumnMiddle.class, ColumnTop.class, ColumnMiddle.class);
		undirectedLink(ColumnMiddle_ColumnBottom.class, ColumnMiddle.class, ColumnBottom.class);
		undirectedLink(ColumnBottom_ColumnBottom.class, ColumnBottom.class, ColumnBottom.class);
		undirectedLink(DiamondTop_DiamondLeft.class, DiamondTop.class, DiamondLeft.class);
		undirectedLink(DiamondTop_DiamondBottom.class, DiamondTop.class, DiamondBottom.class);
		undirectedLink(DiamondTop_DiamondRight.class, DiamondTop.class, DiamondRight.class);
		undirectedLink(DiamondLeft_DiamondRight.class, DiamondLeft.class, DiamondRight.class);
		undirectedLink(DiamondBottom_DiamondLeft.class, DiamondBottom.class, DiamondLeft.class);
		undirectedLink(DiamondBottom_DiamondRight.class, DiamondBottom.class, DiamondRight.class);
		undirectedLink(Random_BaseOfColumnTop.class, Random.class, BaseOfColumnTop.class);
		undirectedLink(Random_BetweenBases.class, Random.class, BetweenBases.class);
		undirectedLink(Random_BaseOfDiamond.class, Random.class, BaseOfDiamond.class);
		...
		statement(StatementType.west, ColumnBottom_ColumnBottom.class, ColumnBottom.class, LinkEnd.Start.name());
		statement(StatementType.east, ColumnBottom_ColumnBottom.class, ColumnBottom.class, LinkEnd.End.name());
