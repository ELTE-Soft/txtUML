...
public class DiagramElementsModifierTest {
	...
	public void hideConnectionLabelsforEdtipartsTest() {
		...
		Pair<String, Class<?>> B = new Pair<String, Class<?>>("ClassB",
				org.eclipse.uml2.uml.Class.class);
		Pair<String, Class<?>> C = new Pair<String, Class<?>>("ClassC",
				org.eclipse.uml2.uml.Class.class);
		...
		List<Pair<Pair<String, Class<?>>, Pair<String, Class<?>>>> associations = Arrays
				.asList(new Pair<Pair<String, Class<?>>, Pair<String, Class<?>>>(
						A, B),
						new Pair<Pair<String, Class<?>>, Pair<String, Class<?>>>(
								C, C));
		...
		DiagramElementsModifier.hideConnectionLabelsForEditParts(
				Arrays.asList(classAEp, classBEp), Arrays.asList());
		DiagramElementsModifier.hideConnectionLabelsForEditParts(
				Arrays.asList(classCEp),
				Arrays.asList(AssociationNameEditPart.class));

		Assert.assertTrue(assoc1.getChildren().get(0) instanceof AppliedStereotypeAssociationEditPart);
		AppliedStereotypeAssociationEditPart ass1_child1 = (AppliedStereotypeAssociationEditPart) assoc1
				.getChildren().get(0);
		...
		AssociationNameEditPart ass1_child2 = (AssociationNameEditPart) assoc1
				.getChildren().get(1);
		...
		AssociationEndTargetEditPart ass1_child3 = (AssociationEndTargetEditPart) assoc1
				.getChildren().get(2);
		...
		AssociationEndSourceEditPart ass1_child4 = (AssociationEndSourceEditPart) assoc1
				.getChildren().get(3);
		...
		AssociationMultiplicitySourceEditPart ass1_child5 = (AssociationMultiplicitySourceEditPart) assoc1
				.getChildren().get(4);
		...
		AssociationMultiplicityTargetEditPart ass1_child6 = (AssociationMultiplicityTargetEditPart) assoc1
				.getChildren().get(5);
		...
		AppliedStereotypeAssociationEditPart ass2_child1 = (AppliedStereotypeAssociationEditPart) assoc2
				.getChildren().get(0);
		...
		AssociationNameEditPart ass2_child2 = (AssociationNameEditPart) assoc2
				.getChildren().get(1);
		...
		AssociationEndTargetEditPart ass2_child3 = (AssociationEndTargetEditPart) assoc2
				.getChildren().get(2);
		...
		AssociationEndSourceEditPart ass2_child4 = (AssociationEndSourceEditPart) assoc2
				.getChildren().get(3);
		...
		AssociationMultiplicitySourceEditPart ass2_child5 = (AssociationMultiplicitySourceEditPart) assoc2
				.getChildren().get(4);
		...
		AssociationMultiplicityTargetEditPart ass2_child6 = (AssociationMultiplicityTargetEditPart) assoc2
				.getChildren().get(5);
