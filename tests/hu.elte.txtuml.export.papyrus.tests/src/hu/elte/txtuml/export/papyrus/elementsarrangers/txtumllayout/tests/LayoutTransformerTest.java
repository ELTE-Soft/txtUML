...
public class LayoutTransformerTest {
	...
	public void testGapX(){
		LayoutTransformer layoutTransformer = new LayoutTransformer(1, 1, 2, 0, 0, 0);
	...
	public void testGapY(){
		LayoutTransformer layoutTransformer = new LayoutTransformer(1, 1, 0, 2,0, 0);
	...
	public void testFlipXAxis() {
		LayoutTransformer layoutTransformer = new LayoutTransformer(1, 1, 0, 0, 0, 	0);
	...
	public void testScaleX(){
		LayoutTransformer layoutTransformer = new LayoutTransformer(100, 1, 0, 0, 0, 0);
	...
	public void testScaleY(){
		LayoutTransformer layoutTransformer = new LayoutTransformer(1, 100, 0, 0, 0, 0);
	...
	public void testScaleWithDensity1(){
		LayoutTransformer layoutTransformer = new LayoutTransformer(100, 50, 0, 0, 1, 1);
	...
	public void testScaleWithDensity5(){
		LayoutTransformer layoutTransformer = new LayoutTransformer(100, 50, 0, 0, 5, 5);
