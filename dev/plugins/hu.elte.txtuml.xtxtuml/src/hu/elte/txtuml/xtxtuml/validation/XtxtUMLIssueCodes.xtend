...
class XtxtUMLIssueCodes {
	...
	public static val AMBIGUOUS_BIND_EXPRESSION = ISSUE_CODE_PREFIX + "ambiguous_bind_expression";
	...
	public static val DATATYPE_HIERARCHY_CYCLE = ISSUE_CODE_PREFIX + "datatype_hierarchy_cycle";
	...
	public static val ORDERED_UNIQUE_ONE_MULTIPLICITY = ISSUE_CODE_PREFIX + "unsupported_multiplicity";
	
	// Multiplicity-related issues
	
	public static val WRONG_MULTIPLICITY = ISSUE_CODE_PREFIX + "wrong_multiplicity";
