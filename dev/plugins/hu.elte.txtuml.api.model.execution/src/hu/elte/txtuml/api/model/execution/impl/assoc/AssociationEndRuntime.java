...
public interface AssociationEndRuntime<T extends ModelClass, C extends GeneralCollection<? super T>>
	...
	static <T extends ModelClass, C extends GeneralCollection<? super T>> AssociationEndRuntime<T, C> create(
