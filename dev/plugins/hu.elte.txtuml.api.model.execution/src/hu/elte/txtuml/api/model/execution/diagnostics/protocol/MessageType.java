...
public enum MessageType {
	ACKNOWLEDGED, CHECKIN, CHECKOUT, INSTANCE_CREATION, INSTANCE_DESTRUCTION, PROCESSING_SIGNAL(true), USING_TRANSITION(
			true), ENTERING_VERTEX(true), LEAVING_VERTEX(true);
