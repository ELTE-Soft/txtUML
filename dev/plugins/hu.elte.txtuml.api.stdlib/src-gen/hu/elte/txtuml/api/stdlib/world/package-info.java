 ...
 * <ul>
 * <li>The strings that identify the outside entities and their the world objects that represent them.<br/>
 ...
 * <ol>
 * <li>Create and instance of the required signal (that extends {@code SignalToWorld}).</li>
 ...
 * WorldObjectListener.register} to register for signals of the world object that has the specified
