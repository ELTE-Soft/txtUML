...
public class WorldObject extends ModelClass {
  ...
  WorldObject(final World world, final WorldObjectHelper helper) {
    this.helper = helper;
    Action.<World, WorldObject, ZeroToOne<World>, Any<WorldObject>>link(hu.elte.txtuml.api.stdlib.world.WorldOwnsObject.world.class, world, WorldOwnsObject.objects.class, this);
    Action.start(this);
  }
