...
public class HeaderTemplates {
	...
	public static String hierarchicalStateMachineClassHeader(String dependency, String className,
			List<String> baseClassName, List<String> subMachines, String publicPart, String protectedPart,
			String privatePart, Boolean rt) {
	...
	public static String simpleStateMachineClassHeader(String dependency, String className, List<String> baseClassName,
	...
	public static String classHeader(String dependency, String name, List<String> baseClassName, String publicPart,
	...
	public static String classHeader(String dependency, String className, List<String> baseClassName, String publicPart,
			String protectedPart, String privatePart, Boolean sm, Boolean topMachine) {
		...
		List<String> allBase = new LinkedList<String>();
		if (baseClassName != null) {
			allBase.addAll(baseClassName);
		}
		if (sm) {
			allBase.add(GenerationNames.StatemachineBaseName);
			if (topMachine) {
				allBase.add(RuntimeTemplates.STMIName);
			}
		}
		classDecleration.append(PrivateFunctionalTemplates.baseClassList(allBase));
