...
public abstract class AbstractImporter {
	...
	protected static int importLowerBound(Class<?> fieldClass) throws ImportException
	{
	    if(txtuml.api.Association.One.class.isAssignableFrom(fieldClass))
	    {
	       return 1;
	    }
	    else if(txtuml.api.Association.MaybeOne.class.isAssignableFrom(fieldClass))
	    {
	        return 0;
	    }
	    else if(txtuml.api.Association.Some.class.isAssignableFrom(fieldClass))
	    {
	        return 0;
	    }
	    else if(txtuml.api.Association.Many.class.isAssignableFrom(fieldClass))
	    {
	        return 1;
	    }
	    else
	...
	protected static int importUpperBound(Class<?> fieldClass) throws ImportException
	{
		if(txtuml.api.Association.One.class.isAssignableFrom(fieldClass))
		{
			return 1;
