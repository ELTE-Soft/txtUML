 ...
 * linked-list nodes. See LinkedQueue for the version from the textbook that
 * uses a non-static nested class. The <em>enqueue</em>, <em>dequeue</em>,
...
public class Queue<Item> implements Iterable<Item>
{
	 ...
	 */
	/*
	 * public static void main(String[] args) { Queue<String> q = new
	 * Queue<String>(); while (!StdIn.isEmpty()) { String item =
	 * StdIn.readString(); if (!item.equals("-")) q.enqueue(item); else if
	 * (!q.isEmpty()) StdOut.print(q.dequeue() + " "); } StdOut.println("(" +
