...
public class EdgeWeightedDigraph
{
	...
	{
		if (v < 0 || v >= V)
			throw new IndexOutOfBoundsException("vertex " + v + " is not between 0 and "
					+ (V - 1));
	}
	 ...
	 */
	/*
	 * public static void main(String[] args) { In in = new In(args[0]);
	 * EdgeWeightedDigraph G = new EdgeWeightedDigraph(in); StdOut.println(G); }
	 */
