...
/**
 * ModelMapCollector can be used to collect and save a mapping from txtUML model
 * elements to EMF-UML2 model elements.
 * 
...
public class ModelMapCollector {
	 ...
	 * 
	 * @param className
	 *            Fully qualified name of the txtUML model element.
	 * @param eObject
	 *            The EObject representing the same model element in the
	 *            EMF-UML2 model.
	 */
