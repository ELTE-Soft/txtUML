...
import hu.elte.txtuml.layout.export.test.Model2.BaseOfColumnTop;
import hu.elte.txtuml.layout.export.test.Model2.BaseOfDiamond;
import hu.elte.txtuml.layout.export.test.Model2.BetweenBases;
import hu.elte.txtuml.layout.export.test.Model2.ColumnBottom;
import hu.elte.txtuml.layout.export.test.Model2.ColumnBottom_ColumnBottom;
import hu.elte.txtuml.layout.export.test.Model2.ColumnMiddle;
import hu.elte.txtuml.layout.export.test.Model2.ColumnTop;
import hu.elte.txtuml.layout.export.test.Model2.DiamondBottom;
import hu.elte.txtuml.layout.export.test.Model2.DiamondLeft;
import hu.elte.txtuml.layout.export.test.Model2.DiamondRight;
import hu.elte.txtuml.layout.export.test.Model2.DiamondTop;
import hu.elte.txtuml.layout.export.test.Model2.DiamondTop_DiamondBottom;
import hu.elte.txtuml.layout.export.test.Model2.Random;
