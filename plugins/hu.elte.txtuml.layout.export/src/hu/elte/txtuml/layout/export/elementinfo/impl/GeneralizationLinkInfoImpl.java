...
/**
 * Implementation for {@link LinkInfo} which contains information about a generalization link.
 * 
 * @author Gabor Ferenc Kovacs
 *
 */
public class GeneralizationLinkInfoImpl extends LinkInfoImpl implements LinkInfo {

	public GeneralizationLinkInfoImpl(Class<?> elementClass,
			DiagramType diagType, String asString, NodeInfo start, NodeInfo end) {
		super(elementClass, diagType, asString, start, end);
	}
