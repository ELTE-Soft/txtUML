...
/**
 * Collects problems into a ReconcileContext. To be used for reconcile-time
 * validation. Problems are persisted, can be added and removed.
 */
public class ProblemCollectorForReconcile extends ProblemCollector {
	...
	public ProblemCollectorForReconcile(ReconcileContext context, IMarker[] markers) {
		...
		try {
			this.sourceInfo = new ASTSourceInfo(context.getAST8());
		} catch (JavaModelException e) {
			PluginLogWrapper.logError("Error while preparing source info", e);
		}
