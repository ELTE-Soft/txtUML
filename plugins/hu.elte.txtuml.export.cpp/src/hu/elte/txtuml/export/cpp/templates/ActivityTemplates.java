...
public class ActivityTemplates {
	...
	public static String SignalSend(String signalName_, String targetName_, String targetTypeName_,
			String accessOperator_, List<String> params_, Boolean rt_) {
	...
	public static String OperationCall(String ownerName_, String accessOperator_, String operationName_,
			List<String> params_) {
	...
	public static String CreateObject(String typenName_, String objName_, Boolean rt_, Boolean isSm_) {
		String source;
		if (rt_ && isSm_) {
			source = GenerationNames.PointerType(typenName_) + " " + objName_ + "= " + GenerationNames.MemoryAllocator
					+ " " + typenName_ + "(" + RuntimeTemplates.RuntimeVarName + ");\n";
	...
	public static String AccesOperatoForType(String typeName_)// Everything is
																// pointer
	{
